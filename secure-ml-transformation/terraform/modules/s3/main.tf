...
resource "aws_s3_bucket" "processed_data" {
  bucket = "${var.name_prefix}-processed-${data.aws_caller_identity.current.account_id}"
...
resource "aws_s3_bucket" "scripts" {
  bucket = "${var.name_prefix}-scripts-${data.aws_caller_identity.current.account_id}"
